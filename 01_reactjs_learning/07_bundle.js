...
var ImageText = React.createClass({displayName: "ImageText",
  ...
  render:function() {
    var $__0=   this.props,text=$__0.text,other=(function(source, exclusion) {var rest = {};var hasOwn = Object.prototype.hasOwnProperty;if (source == null) {throw new TypeError();}for (var key in source) {if (hasOwn.call(source, key) && !hasOwn.call(exclusion, key)) {rest[key] = source[key];}}return rest;})($__0,{text:1});
    return (
      React.createElement("span", null, text, React.createElement("img", React.__spread({},  other, {onClick: this.onClick})))
    );
  }
});

React.render(
  React.createElement(ImageText, {text: "名前です", src: "https://facebook.github.io/react/img/logo.svg", width: "200", height: "200"}),
