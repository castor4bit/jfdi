...
React.render(
  ...
  React.createElement(Tr, {className: "special-row", data: { Age: 14, Name: 'Ichigo Hoshimiya'}}), 
  React.createElement(Tr, {className: "special-row", data: { Age: 13, Name: 'Akari Oozora'}}), 
  React.createElement(Tr, {className: "special-row", data: { Age: 14, Name: 'Otome Arisugawa'}}), 
  React.createElement(Tr, {className: "special-row", data: { Age: 14, Name: 'Aoi Kiriya'}})
  ),
...
var LaddaExample = React.createClass({displayName: "LaddaExample",
  ...
  render: function() {
    return (
      React.createElement(LaddaButton, {active: this.state.active, progress: this.state.progress, color: "green", size: "s", style: "expand-right"}, 
      React.createElement("button", {onClick: this.onClick}, React.createElement("span", null, this.state.message))
      )
    );
  }
});
...
React.render(
  React.createElement(LaddaExample, null),
...
},{"react":178,"react-ladda":3,"reactable":179}],3:[function(require,module,exports){
var React = require('react');
...
},{"ladda/dist/ladda.min":4,"react":178,"react/addons":6}],4:[function(require,module,exports){
/*!
...
},{"spin.js":5}],5:[function(require,module,exports){
/**
